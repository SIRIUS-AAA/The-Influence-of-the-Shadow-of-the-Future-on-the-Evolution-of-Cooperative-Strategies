...
# --- put near the top of exp1_interactive_llm.py ---
import os
...
# os.environ["PENAI_API_KEY"] = "sk-vWPlVDMJizXLti9l69ah2W5l0bdGKxwh1OnBBRuhwtPJL4ed"
# os.environ["DEEPSEEK_API_KEY"] = "sk-cb387c428d9343328cea734e6ae0f9f5"
# os.environ["ANTHROPIC_API_KEY"] = ''
# os.environ["MOONSHOT_API_KEY"] = 'sk-8dW8q949DUpVaWjKtATKUovMvabr0VlU0cE3WTFYsdu0Ugwz'
# os.environ["DOUBAO_API_KEY"] = '068a6b39-c13c-4df2-8253-7d5bfe1cca51'
...
def act_doubao(prompt: str, round_idx: int) -> str:
    ...
    url = os.environ.get("DOUBAO_API_BASE", "https://ark.cn-beijing.volces.com/api/v3")
...
def main():
    print("\n=== LLM × Game Theory — 交互式大模型对战 ===")

    # 1) 可选大模型注册表（把你要对战的模型都放进来）
